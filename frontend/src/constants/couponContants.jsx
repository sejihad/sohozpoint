...
export const CLEAR_COUPON_FAIL = "CLEAR_COUPON_FAIL";
export const CLEAR_COUPON_REQUEST = "CLEAR_COUPON_REQUEST";
export const CLEAR_COUPON_SUCCESS = "CLEAR_COUPON_SUCCESS";

export const CLEAR_COUPON_RESET = "CLEAR_COUPON_RESET";
// -------------------- Clear Errors --------------------
