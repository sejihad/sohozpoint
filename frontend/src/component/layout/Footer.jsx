            ...
            <ul className="space-y-4 text-gray-600">
              ...
              <li className="flex items-center">
                ...
                <div className="space-y-1 text-sm">
                  <div>+880 1577-344846</div>
                  <div>+880 1627-283382</div>
                  <div>+880 1981-403402</div>
                </div>
              </li>
              <li className="flex items-center">
                <svg
                ...
                <div className="space-y-1 text-sm">
                  <div>sohozpoint.com@gmail.com</div>
                  <div>info@sohozpoint.com</div>
                  <div>mdrokon909000@gmail.com</div>
                </div>
              </li>
            </ul>
          </div>
