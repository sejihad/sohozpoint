        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <div className="flex gap-6 pt-4">
              <a
                href="#"
                className="text-gray-500 hover:text-green-600 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1"
              >
                <div className="bg-gray-100 hover:bg-green-50 p-3 rounded-full transition-all duration-300">
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 24 24"
